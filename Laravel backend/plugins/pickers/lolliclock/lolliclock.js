...
(function () {
  ...
  console.log(LolliClock.DEFAULTS.scheme);
  ...
  function LolliClock(element, options) {
    ...
    if(this.options.schemePopover){
      this.popover.addClass(this.options.schemePopover);
    }
    if(this.options.schemeHead){
      this.header.addClass(this.options.schemeHead);
    }
    if(this.options.schemePlat){
      this.plate.addClass(this.options.schemePlat);
    }
  ...
  LolliClock.prototype.changeAmPm = function (isAmOrPm) {
    ...
    var togClass=(this.options.schemeActBtn)?'lolliclock-active-button-background '+ this.options.schemeActBtn:'lolliclock-active-button-background';
    $(this.amButton[0].childNodes[0]).toggleClass(togClass, (this.amOrPm === 'AM'));
    $(this.pmButton[0].childNodes[0]).toggleClass(togClass, (this.amOrPm === 'PM'));
