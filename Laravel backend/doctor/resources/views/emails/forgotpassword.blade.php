      ...
      <div style="width: 100%; margin:auto; max-width:630px;">
        ...
        <div style="float:left; width: 100%; background: #FFFFFF; box-shadow: 0px 0px 20px rgba(0, 0, 0, 0.25); border-radius: 0; border-top:5px solid #595959; padding: 15px;">
          ...
          <div style="float:left; width: 100%; display: block;">
            <h2 style=" vertical-align:middle; text-align: center;font-family: IRANSansWeb; font-style: normal; font-weight: bold; font-size: 30px; line-height: 34px; color: #535353;">ﺍﻋﺎﺩﺓ ﺗﻌﻴﻴﻦ ﻛﻠﻤﺔ ﺍﻟﻤﺮﻭﺭ</h2>
        </div>
          <div style="float:left; width: 100%; display: block;">
            <h2 style=" vertical-align:middle; text-align: center;font-family: IRANSansWeb; font-style: normal; font-weight: bold; font-size: 24px; line-height: 34px; color: #535353;">ﻟﺘﻌﻴﻴﻦ ﻛﻠﻤﺔ ﻣﺮﻭﺭ ﺟﺪﻳﺪﺓ ﻳﺮﺟﻰ ﺍﻟﻀﻐﻂ ﻋﻠﻰ ﺍﻟﺮﺍﺑﻂ ﺍﻟﺘﺎﻟﻲ</h2>
          </div>
          <div style="float: left; width: 100%; display: block; margin-top: 40px; margin-bottom: 125px;    direction: rtl;">
            <div style="padding:15px 25px; background: #3B99DA; border-radius: 3px; display: block; margin: auto;  max-width:220px;text-align:center;">
              <a href="{{url('https://ehospital.online/resetpassword/'. $user->api_token)}}" style=" font-family: IRANSansWeb; font-style: normal; font-weight: bold; font-size: 24px; line-height:34px; color: #FFFFFF; display: inline-block; vertical-align: middle;"><img src="{{asset('addbyme/images/arrow.png')}}" alt="arrow" style="display: inline-block; vertical-align: middle;">     ﺍﻋﺎﺩﺓ ﺗﻌﻴﻴﻦ ﻛﻠﻤﺔ ﻣﺮﻭﺭ ﺟﺪﻳﺪﺓ</a>
              </div>
          </div>
          <div style="float: left; width: 100%; display: block;">
