      ...
      <div class="mainpage">
        <div class="container">
            ...
            <div class="drInfoMain">
              <div class="right-sec" style="width:150px;">
                  ...
                  <div class="col-lg-6 d-flex align-items-center justify-content-center justify-content-lg-end">
                    <div class="consultbtn-sec spaceCol">
                      <ul>
                        ...
                        <li>
                          <a href="{{ url('/createmessage/'.$doctor->id)}}" class="btn btnStyle btn_success">بدء الاستشارة التخصصية <img src="{{asset('addbyme/images/right-arrow.svg')}}" class="rgtArrow left-spac" alt="right-arrow"> </a>
                        </li>
                      </ul>
                    </div>
                  </div>
                  ...
                  <div class="col-lg-6 d-flex align-items-center justify-content-center justify-content-lg-end">
                    <div class="consultbtn-sec">
                      <ul>
                        ...
                        <li>
                          <a href="{{ url('/createunmessage/'.$doctor->id)}}" class="btn btnStyle btn_success">بدء الاستشارة التخصصية <img src="{{asset('addbyme/images/right-arrow.svg')}}" class="rgtArrow left-spac" alt="right-arrow"> </a>
                        </li>
                      </ul>
                    </div>
                  </div>
